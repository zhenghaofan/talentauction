...
public class CompanyController {
	...
	@RequestMapping(value = "wechatBidLogs")//获取企业拍卖纪录
	@ResponseBody
	public void wechatBidLogs(HttpServletRequest request,HttpServletResponse response) throws Exception {
		String result = companyService.wechatBidLogs(request);
        new Util().responesWriter(response,result);
	}
	
	@RequestMapping(value = "readDetail")//拍卖纪录获取详情
	@ResponseBody
	public void readDetail(HttpServletRequest request,HttpServletResponse response) throws Exception {
		String result = this.companyService.readDetail(request);
        new Util().responesWriter(response,result);
	}
